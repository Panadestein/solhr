...
vector<string> split_querie(const string &query, char firstDelim, char secondDelim)
{
    vector<string> tokens;
...
// Parse query
void parse_query(const vector<string> &queryTokens, const shared_ptr<Tag> hrml)
{
